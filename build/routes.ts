...
const models: TsoaRoute.Models = {
    "UnauthenticatedErrorJSON": {
        "dataType": "refObject",
        "properties": {
            "message": {"dataType":"enum","enums":["Authentication invalid!"],"required":true},
        },
    ...
    "RegisterParams": {
        "dataType": "refAlias",
        "type": {"dataType":"intersection","subSchemas":[{"ref":"LoginParams"},{"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string","required":true}}}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Types.ObjectId": {
        "dataType": "refAlias",
    ...
    "Job": {
        ...
        "properties": {
            ...
            "createdBy": {"ref":"Types.ObjectId","required":true,"validators":{"pattern":{"value":"[0-9a-fA-F]{24}"}}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/cookie-auth/refresh',
            ...(fetchMiddlewares<RequestHandler>(CAuthController)),
            ...(fetchMiddlewares<RequestHandler>(CAuthController.prototype.refresh)),

            function CAuthController_refresh(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/cookie-auth/logout',
            ...(fetchMiddlewares<RequestHandler>(CAuthController)),
            ...(fetchMiddlewares<RequestHandler>(CAuthController.prototype.logout)),

            function CAuthController_logout(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/header-auth/refresh',
            ...(fetchMiddlewares<RequestHandler>(HAuthController)),
            ...(fetchMiddlewares<RequestHandler>(HAuthController.prototype.refresh)),

            function HAuthController_refresh(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/header-auth/logout',
            ...(fetchMiddlewares<RequestHandler>(HAuthController)),
            ...(fetchMiddlewares<RequestHandler>(HAuthController.prototype.logout)),

            function HAuthController_logout(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
        ...
        app.get('/jobs',
            ...
            ...(fetchMiddlewares<RequestHandler>(JobsController.prototype.getAllJobs)),

            function JobsController_getAllJobs(request: any, response: any, next: any) {
            const args = {
                    bearerToken: {"in":"header","name":"Authorization","required":true,"dataType":"string"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.getAllJobs.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 200, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/jobs/:jobId',
            ...
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    jobId: {"in":"path","name":"jobId","required":true,"ref":"Types.ObjectId"},
            };
        ...
        app.post('/jobs',
            ...
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    body: {"in":"body","name":"body","required":true,"ref":"JobCreateParams"},
            };
        ...
        app.patch('/jobs/:jobId',
            ...
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    jobId: {"in":"path","name":"jobId","required":true,"ref":"Types.ObjectId"},
                    body: {"in":"body","name":"body","required":true,"ref":"JobUpdateParams"},
            };
